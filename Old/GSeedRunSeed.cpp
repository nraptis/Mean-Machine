...
bool GSeedRunSeed::Build(TwistProgramBranch &pBranch,
    ...
    // 5..8 expansion -> WorkLanes
    if (!EmitKDF(TwistDomain::kSaltsWorkLaneOrbiter, aExpandA, aWorkA, "seed-kdf: WorkLanes 1")) { return false; }
    if (!EmitKDF(TwistDomain::kSaltsWorkLaneOrbiter, aExpandB, aWorkB, "seed-kdf: WorkLanes 2")) { return false; }
    if (!EmitKDF(TwistDomain::kSaltsWorkLaneOrbiter, aExpandC, aWorkC, "seed-kdf: WorkLanes 3")) { return false; }
    if (!EmitKDF(TwistDomain::kSaltsWorkLaneOrbiter, aExpandD, aWorkD, "seed-kdf: WorkLanes 4")) { return false; }

    // 9..12 WorkLanes -> operation lanes
    ...
    // 13..16 operation lanes -> WorkLanes
